...
1. Склонироваать проект на ваш компьютер с Github c помощью команды: 
    >git clone https://github.com/MikeChe419/JS-course-work-CRM

2. Установить зависимости:
    >npm install 

3. Из директории crm-backend  в терминале выполнить команду:
    > node index.js

4. Запуск клиентской части проекта из директории crm-frontend командой 
    >gulp
